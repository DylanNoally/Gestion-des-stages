				...
				<h2 style="margin-bottom: 30px;">Nouvelle entreprise</h2>
					...
					<form action="informationsEntreprise.php" method="POST" >
						...
						<div class="chiffreAffaires">
							Chiffre d'affaires :<input class="chiffreAffaires_input" type="text" name="chiffreAffaires">
						</div>

						Adresse postale :<input class="adressePostale_input" type="text" name="adressePostale">
