...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 04 Mai 2017 à 02:54
...
(1, 'mentalworks.fr', 'Mentalworks', 123100000, 'Compiègne', 2),
(2, 'codeaitec.fr', 'Codeaitec', 234100000, 'Courtry', 1),
(3, 'ipotechnologie.fr', 'Ipo Technologie', 345100000, 'Decines Charpieu', 2),
(4, 'sicmarking.com', 'Sic Marking', 46100000, 'Pommiers', 2),
...
(11, 'ocean.fr', 'Ocean', 600000000, 'Clichy', 2),
(12, 'enertopia.fr', 'Enertopia', 255000000, 'Paris', 1),
(13, 'intercodeservices.com', 'Intercode Services', 286100000, 'Aix En Provence', 1),
(14, 'seimn.fr', 'Seim N', 22000000, 'Thouare Sur Loire', 2),
(15, 'nodevo.com', 'Nodevo', 111960000, 'Chantilly', 2);
...
CREATE TABLE IF NOT EXISTS `etudiant` (
  ...
  `Annee_obtention_bac_etudiant` year(4) NOT NULL,
...
(1, 'ALIOUATE', 'Adnane', '1994-03-03', 2013, '27 rue de Mozart, CREIL', '0699410263', 3),
(2, 'AZI', 'Sofiane', '1995-08-01', 2016, '77 rue du Puit NOGENT-SUR-OISE', '0644082156', 3),
(3, 'SUSSET', 'Romain', '1998-02-08', 2016, '5 Boulevard Diderot 75012 PARIS', '0644688827', 5),
(4, 'MACHIOCCU', 'Mathias', '1998-03-04', 2016, '1 place d''ItalieHôtel de Ville 75634 PARIS CEDEX 1', '0644081270', 3),
(5, 'GOURIN', 'Antoine', '1998-03-06', 2016, '18 rue des BatignollesHôtel de Ville 75840 PARIS C', '0653091012', 3),
(6, 'DURIEZ', 'Quentin', '1995-10-22', 2012, '67 rue des Coquelicots  BLAINCOURT LES PRECYS', '0647773036', 3),
(7, 'MARTIN', 'Thomas', '1997-02-05', 2015, '15 bis rue Ordener 75018 PARIS CEDEX 18', '0644691950', 4),
(8, 'DEGAUGUE', 'David', '1996-06-17', 2014, '31 rue PecletHôtel de Ville 75732 PARIS CEDEX 15', '0656562315', 4),
(9, 'MONMART', 'Jean-Emile', '1997-04-21', 2015, '14 RUE BREVIN 75014 PARIS', '0653903200', 4),
(10, 'GODSON', 'Valerick', '1998-08-14', 2016, '23 rue Bichat 75475 PARIS CEDEX 10', '0653192626', 2),
(11, 'EMPTY', 'Vincent', '0000-00-00', 2016, '21 place du PanthéonMairie de Paris 75231 PARIS', '0656817505', 2),
(12, 'MANDAMBU FUKIAWU', 'Gradi', '1998-07-04', 2016, '68 rue des plantes 75014 PARIS', '6022474568', 4),
(13, 'NOALLY', 'Dylan', '1997-05-02', 2012, '2 rue Chemin du Roc CINQUEUX', '0636541420', 5),
(14, 'POPYK', 'Dylan', '1994-06-16', 2012, '19 rue des Joncquilles CREIL', '0621339874', 3),
(15, 'ALAYA', 'Hedi', '1994-07-08', 2012, '14 rue des pissenlits SENLIS', '0685741236', 5);
...
(5, 'AMMAR', 'Professeur', 'fammar@nodevo.com', '0654841473');
...
(1, 'AMMAR FETHI', 'Professeur', 'fammar@nodevo.com', '0654841473', 15),
...
(15, 'MARTINS-JACQUELOT', 'Développeur web', 'jeffmartins@jacquelot.com', '0685479120', 1);
...
(1, '2017-05-29', '2017-06-30', 'Développement Application', 'Des difficultés, mais persévère pour gagner en autonomie', 15, 5, 15, 15, 5),
...
(3, '2017-05-29', '2017-06-30', 'Développement web', 'Quand je suis allé à l''école, ils m''ont demandé ce que je voulais être quand je serais grand. J''ai répondu "heureux". Ils m''ont dit que je n''avais pas compris la question, j''ai répondu qu''ils n''avaient pas compris la vie.', 3, 5, 4, 6, 5),
...
(6, '2017-05-29', '2017-06-30', 'Développement web', 'Nos premiers maîtres de philosophie sont nos pieds, nos mains, nos yeux. Substituer des livres à tout cela, ce n''est pas nous apprendre à raisonner, c''est nous apprendre à nous servir de la raison d''autrui.', 6, 2, 5, 7, 5),
(7, '2017-05-29', '2017-06-30', 'Développement web', 'On ne doit pas mourir pour ses amis...\r\nOn doit vivre pour eux...\r\nc''est le secret d''un avenir heureux!', 12, 2, 13, 3, 5),
(8, '2017-05-29', '2017-06-30', 'Développement web', 'Parle sans savoir, on te croira sot ;\nParle en sachant, on te croira vaniteux ;\nTais-toi, on te croira sage.', 8, 3, 7, 9, 5),
(9, '2017-05-29', '2017-06-30', 'Développement web', 'Placez votre main sur un poêle une minute et ça vous semble durer une heure. Asseyez vous auprès d''une jolie fille une heure et ça vous semble durer une minute. C''est ça la relativité.', 9, 3, 9, 10, 5),
(10, '2017-05-29', '2017-06-30', 'Développement web', 'Dans le monde actuel, nous investissons 5 fois plus d''argent pour la virilité masculine et en silicone pour les seins des femmes que pour la guérison de la maladie d''Alzheimer.\r\nDans quelques années, nous aurons des vieilles avec des gros seins, des vieux à la verge dure, mais aucun d''entre eux ne se rappellera à quoi ça sert.', 10, 4, 10, 11, 5),
(11, '2017-05-29', '2017-06-30', 'Développement web', 'Pour vouloir, il faut pouvoir; Pour pouvoir, il faut savoir; Pour savoir, il faut connaitre; Pour connaitre, il faut appendre; Mais pour appendre, il faut vouloir...', 11, 4, 11, 12, 5),
(12, '2017-05-29', '2017-06-30', 'Développement webv', 'Nous sommes comme des livres ! La plupart des gens ne voient que notre couverture... Au mieux ils lisent notre résumé, ou bien se fient à la critique que d''autres en font. Mais ce qui est certain, c''est que très peu d''entre eux connaissent vraiment notre histoire.', 7, 2, 8, 8, 5),
(13, '2017-05-29', '2017-06-30', 'Développement web', 'On ne voit que ce qu''on veut voir, on n''entend que ce qu''on veut entendre,pire est celui qui ne veut voir, pire est celui qui ne veut entendre.', 13, 5, 12, 13, 5),
(14, '2017-05-29', '2017-06-30', 'Développement web', 'Quand le dernier arbre aura été coupé,\nQuand la dernière rivière aura été empoisonnée,\nQuand le dernier poisson aura été attrapé,\nSeulement alors,\nl''Homme se rendra compte que l''argent ne se mange pas.', 14, 5, 14, 14, 5),
(15, '2017-05-28', '2017-06-30', 'Développement web', 'Etudiant sérieux et une assiduité omniprésente', 3, 2, 4, 3, 2);
...
(1, '2016-06-04', 'Travail satisfaisant et assiduité à la réalisation de ses tâches', 15),
...
(4, '2017-04-29', 'Reste toujours bon', 15),
(5, '2017-04-27', 'Peux mieux faire', 1),
(6, '2017-04-25', 'Voila voila', 15),
...
(29, '2017-05-01', 'L''idiotie des gens renforce mon intelligence', 15),
